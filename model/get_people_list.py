...
class GetPoepleList(object):
    ...
    #def GetPeople(self, count):
    #    sql = "MissingPeople (userid, userphone, userloc, missing_name, missing_age, missing_sex, missing_city, missing_date, missing_desc, photoUrl ) values (\"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\" );"
